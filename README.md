...
#### NOTE: Hiragana can be used for everything, however, foreign names or foreign / borrowed words are written in Katakana. Words that can written in Kanji should also replace their Hiragana counterpart
